...
data class OcrRect(val left: Int, val top: Int, val right: Int, val bottom: Int) {
    ...
    fun regionBucket(imageWidth: Int, imageHeight: Int, gridRows: Int = 6, gridCols: Int = 6): Int {
...
data class OcrRectF(val left: Float, val top: Float, val right: Float, val bottom: Float) {
